...
export const getAddress = (
  ...
  try {
    ...
    const res = await axios.get(`https://maps.googleapis.com/maps/api/geocode/json?latlng=${latitude},${longitude}&language=en-GB&result_type=street_address&key=AIzaSyC9Xcr5cJQJD4S7xjZGwFTAQyV08v0uoig`)
